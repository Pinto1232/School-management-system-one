...
import { Select, Box, Text, VStack, Heading, Flex, Spinner, Button } from '@chakra-ui/react';
    ...
    return (
        <VStack bgGradient={bgBack} borderRadius={bordeRad} alignItems="start" {...props} p={4} h={'290px'}>
            <Flex justifyContent="space-between" w="full">
                ...
                <Button onClick={() => console.log('Detailed breakdown clicked')}>View Details</Button>
            </Flex>
            <Box w="100px" mt={'50px'}>
