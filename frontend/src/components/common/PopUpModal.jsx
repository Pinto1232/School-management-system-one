import { Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, Box, Text } from "@chakra-ui/react";
import { useState } from "react";

const PopupModal = ({ triggerText, headerText, bodyText, confirmText, cancelText }) => {
