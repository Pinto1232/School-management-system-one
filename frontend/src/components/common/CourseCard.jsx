...
const CourseCard = ({ title, description, imageUrl, duration, level, onFavoriteToggle, isFavorite, isLoading }) => {
  ...
  if (isLoading) {
    return (
      <Box borderWidth="1px" borderRadius="lg" overflow="hidden" bg={cardBg} boxShadow="xl" w="100%" p="4" display="flex" justifyContent="center" alignItems="center">
        <Spinner size="xl" />
      </Box>
    );
  }
  ...
  return (
    <Box borderWidth="1px" borderRadius="lg" overflow="hidden" bg={cardBg} boxShadow="2xl" width={280} height={576} >
      <Image src={imageUrl} alt={title} width="100%" height="199px" objectFit="cover" />
      <Box p="6">
