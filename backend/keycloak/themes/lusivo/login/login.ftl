          ...
          <div id="kc-form-wrapper">
            <#if realm.password>
                <form id="kc-form-login" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post" novalidate="novalidate">
                    ...
                    <@buttons.actionGroup>
                        <button class="${properties.kcButtonPrimaryClass} ${properties.kcButtonBlockClass} lusivo-login-button" name="login" id="kc-login" type="submit">
                            <span class="lusivo-login-button__idle">${msg("doLogIn")}</span>
                            <span class="lusivo-login-button__pending">
                                <@spinner.circle />
                                <span>${msg("signingIn")}</span>
                            </span>
                        </button>
                    </@buttons.actionGroup>
                </form>
