...
const TesPage = () => {
  ...
  return (
    <Box>
      ...
      <Box maxW="4xl" mx="auto" mt={10} p={6} borderWidth={1} rounded="md">
        {/* Slideshow component */}
        <Slideshow slides={slidesData} speed={5000} stopOnHover={true} />
      </Box>
      ...
      <Box maxW="4xl" mx="auto" mt={10} p={6} borderWidth={1} rounded="md">
        <TableWithIcons productsImages={productsImagesData} />
      </Box>
      ...
      <Box
        ...
        rounded="md"
      >
        <SocialMedia size="lg" color="gray.500" align="center" />
      </Box>
      ...
      >
        <AdjustableColumnLayout columns={5}>
          <Box bg={"bisque"} color={"black"}>
            Column 1 content
          </Box>
          <Box bg={"InfoText"} color={"black"}>
            Column 2 content
          </Box>
          <Box bg={"aliceblue"} color={"black"}>
            Column 3 content
          </Box>
          <Box bg={"InfoText"} color={"black"}>
            Column 2 content
        ...
        >
          <Grid>
            <Text fontSize="lg" mb={4}>
              ...
              euismod aliquam commodo. Vestibulum pharetra semper urna, ac
              dapibus felis ultricies ut. Duis pharetra sapien non magna
              ullamcorper, ut scelerisque enim sagittis.
            </Text>
            <Text fontSize="lg">
              Nullam at ipsum quis nibh posuere ultrices. Nam posuere, purus sed
              finibus venenatis, enim urna commodo mauris, at aliquet metus
              lorem vitae mauris.
            </Text>
          </Grid>
        </AboutUsSection>
      ...
      <Box
        ...
        rounded="md"
      >
        <ServicesSections title="Our Services" services={services} />
      </Box>
      ...
      >
        <h1>My Map</h1>
        <Maps latitude={40.7128} longitude={-74.006} zoom={12} />
      </Box>
      ...
      <Box
        ...
        rounded="md"
      >
        <Chatbot messages={chatHistory} onSendMessage={handleSendMessage} />
 ...
 */}
      ...
      <Box
        ...
        rounded="md"
      >
        <TabbedContent tabs={tabContentData} />
      </Box>
